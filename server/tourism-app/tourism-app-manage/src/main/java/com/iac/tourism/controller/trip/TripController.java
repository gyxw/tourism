...
import com.iac.tourism.service.trip.TripService;


@Controller
@RequestMapping("trip/trip")
public class TripController extends BasicController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Page<Trip> page = tripService.findPage(searchParams, pageNumber, pageSize, sortType);
	...
	public String update(@Valid @ModelAttribute("trip") Trip trip, 
	 ...
	 */
	@ModelAttribute
	public void getTrip(@RequestParam(value = "id", defaultValue = "-1") java.lang.Long id, Model model) {
		if (id != -1) {
