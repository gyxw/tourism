package com.iac.tourism.controller.info;
...
import com.iac.tourism.service.info.AreaService;
...
public class AreaController extends BasicController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		Page<Area> page = areaService.findPage(searchParams, pageNumber, pageSize, sortType);
	 ...
	 */
	@ModelAttribute
	public void getArea(@RequestParam(value = "id", defaultValue = "-1") java.lang.Long id, Model model) {
		if (id != -1) {
